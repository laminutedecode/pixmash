...
var useCompressor$1 = function () {
    var compressImageHook = react.useCallback(function (file_1, compressionMode_1) {
        var args_1 = [];
        for (var _i = 2; _i < arguments.length; _i++) {
            args_1[_i - 2] = arguments[_i];
        }
...
var useConvertor$1 = function () {
    ...
    var _b = react.useState(false), converting = _b[0], setConverting = _b[1];
    useCompressor$1().compressImage;
    var addFiles = react.useCallback(function (newFiles) {
    ...
    var convertSingleFile = react.useCallback(function (fileInfo, options) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, convertFile(fileInfo, options)];
        });
    }); }, []);
    var convertAllFiles = react.useCallback(function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var downloadFileHook = react.useCallback(function (fileInfo) {
        downloadFile(fileInfo);
    }, []);
    var downloadAllFiles = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.default = pixmash;
exports.delay = delay;
exports.downloadFile = downloadFile;
exports.downloadFilesAsZip = downloadFilesAsZip;
exports.formatFileSize = formatFileSize;
exports.useCompressor = useCompressor$1;
exports.useConvertor = useConvertor$1;
exports.vueUseCompressor = useCompressor;
exports.vueUseConvertor = useConvertor;
